    ...
    $.initQuantity = function ($control) {
        $control.each(function () {
            ...
            if (!data) {
                ...
                $plus.click(function () {
                    var val =
                        parseInt($value.val()) + unidad;
                    if ($control.hasClass('quantity-control-cart')) {
                        if (! incrementarProducto($value)) {
                            return false;
                        }
                    }
                    $value.val(val);
                ...
                $minus.click(function () {
                    var val = parseInt($value.val()) - unidad;
                    if ($control.hasClass('quantity-control-cart')) {
                        if (! disminuirProducto($value)) {
                            return false;
                        }
                    }
                    $value.val(val > 0 ? val : unidad);
                    return false
                });
                $value.blur(function () {
